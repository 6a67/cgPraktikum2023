...
struct generic_i0e<T, float>
{
    ...
    static EIGEN_STRONG_INLINE T run(const T& x)
    {
        ...
        const float A[] = {-1.30002500998624804212E-8f,
        ...
        const float B[] = {3.39623202570838634515E-9f,
...
struct generic_i1e<T, float>
{
    ...
    static EIGEN_STRONG_INLINE T run(const T& x)
    {
         ...
         *
         */
        const float A[] = {9.38153738649577178388E-9f,
        ...
        const float B[] = {-3.83538038596423702205E-9f,
...
struct generic_k0e<T, float>
{
    ...
    static EIGEN_STRONG_INLINE T run(const T& x)
    {
        ...
        const float A[] = {1.90451637722020886025E-9f,
        ...
        const float B[] = {-1.69753450938905987466E-9f,
...
struct generic_k0e<T, double>
{
    ...
    static EIGEN_STRONG_INLINE T run(const T& x)
    {
        ...
        const double A[] = {1.37446543561352307156E-16,
...
struct generic_k1e<T, float>
{
    ...
    static EIGEN_STRONG_INLINE T run(const T& x)
    {
        ...
        const float A[] = {-2.21338763073472585583E-8f,
        ...
        const float B[] = {2.01504975519703286596E-9f,
...
struct generic_k1e<T, double>
{
    ...
    static EIGEN_STRONG_INLINE T run(const T& x)
    {
         ...
         *
         */
        const double A[] = {-7.02386347938628759343E-18,
...
struct generic_j0<T, float>
{
    ...
    static EIGEN_STRONG_INLINE T run(const T& x)
    {
        ...
        const float MO[] = {-6.838999669318810E-002f,
        ...
        const float PH[] = {3.242077816988247E+001f,
...
struct generic_j0<T, double>
{
    ...
    static EIGEN_STRONG_INLINE T run(const T& x)
    {
         ...
         *
         */
        const double PP[] = {7.96936729297347051624E-4,
        ...
        const double PQ[] = {9.24408810558863637013E-4,
        ...
        const double QP[] = {-1.13663838898469149931E-2,
        ...
        const double QQ[] = {1.00000000000000000000E0,
        ...
        const double RP[] = {-4.79443220978201773821E9,
                             1.95617491946556577543E12,
                             -2.49248344360967716204E14,
                             9.70862251047306323952E15};
        const double RQ[] = {1.00000000000000000000E0,
...
struct generic_y0<T, double>
{
    ...
    static EIGEN_STRONG_INLINE T run(const T& x)
    {
        ...
        const double QQ[] = {1.00000000000000000000E0,
                             ...
                             2.06209331660327847417E3,
                             2.42005740240291393179E2};
        const double YP[] = {1.55924367855235737965E4,
        ...
        const double YQ[] = {1.00000000000000000000E0,
...
struct generic_j1<T, float>
{
    ...
    static EIGEN_STRONG_INLINE T run(const T& x)
    {
        ...
        const float MO1[] = {6.913942741265801E-002f,
        ...
        const float PH1[] = {-4.497014141919556E+001f,
...
struct generic_j1<T, double>
{
    ...
    static EIGEN_STRONG_INLINE T run(const T& x)
    {
         ...
         *
         */
        const double PP[] = {7.62125616208173112003E-4,
        ...
        const double PQ[] = {5.71323128072548699714E-4,
        ...
        const double QP[] = {5.10862594750176621635E-2,
        ...
        const double RP[] = {-8.99971225705559398224E8,
...
struct generic_y1<T, double>
{
    ...
    static EIGEN_STRONG_INLINE T run(const T& x)
    {
        ...
        const double QQ[] = {1.00000000000000000000E0,
                             ...
                             2.82619278517639096600E3,
                             3.36093607810698293419E2};
        const double YP[] = {1.26320474790178026440E9,
