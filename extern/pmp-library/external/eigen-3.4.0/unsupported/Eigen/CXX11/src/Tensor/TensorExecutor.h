...
struct EigenMetaKernelEval
{
    ...
    run(Evaluator& eval, StorageIndex firstIdx, StorageIndex lastIdx, StorageIndex step_size)
    {
...
struct ExecExprFunctorKernel
{
    ...
    EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE void operator()(cl::sycl::nd_item<1> itemID)
    {
        compute(itemID);
    }
