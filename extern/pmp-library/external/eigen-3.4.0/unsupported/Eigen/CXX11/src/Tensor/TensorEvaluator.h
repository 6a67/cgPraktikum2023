...
struct TensorEvaluator<const TensorCwiseBinaryOp<BinaryOp, LeftArgType, RightArgType>, Device>
{
    ...
    TensorEvaluator(const XprType& op, const Device& device)
        : m_device(device), m_functor(op.functor()), m_leftImpl(op.lhsExpression(), device),
    ...
    EIGEN_STRONG_INLINE void evalSubExprsIfNeededAsync(EvaluatorPointerType, EvalSubExprsCallback done)
    {
        ...
        m_leftImpl.evalSubExprsIfNeededAsync(
            nullptr,
            [this, done](bool) { m_rightImpl.evalSubExprsIfNeededAsync(nullptr, [done](bool) { done(true); }); });
    }
#endif // EIGEN_USE_THREADS
        ...
        m_condImpl.evalSubExprsIfNeeded(
            ...
            [this, done](bool)
            {
                m_thenImpl.evalSubExprsIfNeeded(
                    nullptr,
                    [this, done](bool) { m_elseImpl.evalSubExprsIfNeeded(nullptr, [done](bool) { done(true); }); });
            });
    }
#endif // EIGEN_USE_THREADS
