  ...
  public:
    ...
    EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE TensorVolumePatchOp(const XprType& expr,
        ...
        : m_xpr(expr), m_patch_planes(patch_planes), m_patch_rows(patch_rows), m_patch_cols(patch_cols),
          ...
          m_col_inflate_strides(col_inflate_strides), m_padding_explicit(false), m_padding_top_z(0),
          m_padding_bottom_z(0), m_padding_top(0), m_padding_bottom(0), m_padding_left(0), m_padding_right(0),
