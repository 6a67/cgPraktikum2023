...
__device__ __forceinline__ void EigenFloatContractionKernelInternal16x16(const LhsMapper lhs,
                                                                         const RhsMapper rhs,
                                                                         const OutputMapper output,
...
template <typename Index,
          ...
          bool CHECK_LHS_BOUNDARY,
          bool CHECK_RHS_BOUNDARY>
__device__ __forceinline__ void EigenFloatContractionKernelInternal(const LhsMapper lhs,
                                                                    const RhsMapper rhs,
                                                                    const OutputMapper output,
