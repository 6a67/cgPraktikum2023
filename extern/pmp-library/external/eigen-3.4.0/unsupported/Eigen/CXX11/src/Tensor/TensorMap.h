...
class TensorMap : public TensorBase<TensorMap<PlainObjectType, Options_, MakePointer_>>
{
  public:
    ...
    EIGEN_STRONG_INLINE TensorMap(StoragePointerType dataPtr, Index firstDimension)
        ...
        : m_data(dataPtr), m_dimensions(dim1, dim2, dim3, dim4){EIGEN_STATIC_ASSERT(
        ...
        : m_data(dataPtr), m_dimensions(dim1, dim2, dim3, dim4, dim5){EIGEN_STATIC_ASSERT(
                               5 == NumIndices || NumIndices == Dynamic, YOU_MADE_A_PROGRAMMING_MISTAKE)}
#endif
    ...
    EIGEN_DEVICE_FUNC
    EIGEN_STRONG_INLINE StoragePointerType data()
    {
        return m_data;
    }
    EIGEN_DEVICE_FUNC
    EIGEN_STRONG_INLINE StoragePointerType data() const
    {
        return m_data;
    }
