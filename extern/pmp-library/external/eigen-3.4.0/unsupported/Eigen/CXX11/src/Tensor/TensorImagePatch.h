...
struct ImagePatchCopyOp
{
    ...
    Run(const Self& self, const Index num_coeff_to_copy, const Index dst_index, Scalar* dst_data, const Index src_index)
    {
...
struct ImagePatchPaddingOp
{
    ...
    typedef typename packet_traits<Scalar>::type Packet;
    static EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE void
    Run(const Index num_coeff_to_pad, const Scalar padding_value, const Index dst_index, Scalar* dst_data)
    {
        const Index packet_size = internal::unpacket_traits<Packet>::size;
    ...
    EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE PacketReturnType packet(Index index) const
    {
        ...
        if (inputCols[0] == inputCols[1])
        {
            ...
            const Index rowOffsets[2]
                = {patchOffsets[0] - colOffsets[0] * m_colStride, patchOffsets[1] - colOffsets[1] * m_colStride};
