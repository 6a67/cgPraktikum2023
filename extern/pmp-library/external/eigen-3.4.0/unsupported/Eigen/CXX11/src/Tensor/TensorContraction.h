...
struct TensorContractionBlockMemAllocator
{
    ...
    allocate(Device& d, const Index bm, const Index bk, const Index bn, LhsScalar** lhs_block, RhsScalar** rhs_block)
    {
...
struct TensorContractionKernel
{
    ...
    TensorContractionKernel(
        StorageIndex m_, StorageIndex k_, StorageIndex n_, StorageIndex bm_, StorageIndex bk_, StorageIndex bn_)
    ...
    : public TensorBase<TensorContractionOp<Indices, LhsXprType, RhsXprType, OutputKernelType>, ReadOnlyAccessors>
{
  public:
    ...
    EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE TensorContractionOp(const LhsXprType& lhs,
                                                              ...
                                                              const Indices& dims,
                                                              const OutputKernelType& output_kernel
                                                              = OutputKernelType())
...
struct TensorContractionEvaluatorBase : internal::no_assignment_operator
{
    ...
    {
        m_leftImpl.evalSubExprsIfNeededAsync(nullptr,
                                             [this, done, dest](bool)
                                             {
                                                 m_rightImpl.evalSubExprsIfNeededAsync(
                                                     ...
                                                     [this, done, dest](bool)
                                                     {
                                                         ...
                                                         {
                                                             m_result
                                                                 = static_cast<EvaluatorPointerType>(m_device.allocate(
...
#define TENSOR_CONTRACTION_ASYNC_DISPATCH(METHOD, DONE, ALIGNMENT, ARGS, FN)                                           \
    ...
    evalGemmPartialWithoutOutputKernel(Scalar* buffer, Index k_start, Index k_end, int num_threads) const
    {
