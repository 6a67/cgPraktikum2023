...
{
    eigen_assert(m_factorizationIsOk
                 && "The decomposition is not in a valid state for extracting factors, you must first call either "
...
{
    eigen_assert(m_factorizationIsOk
                 && "The decomposition is not in a valid state for computing the determinant, you must first call "
