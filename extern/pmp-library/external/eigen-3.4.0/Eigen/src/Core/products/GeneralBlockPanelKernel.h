...
class gebp_traits
{
  public:
    ...
    madd(const LhsPacketType& a, const RhsPacketType& b, AccPacketType& c, RhsPacketType& tmp, const LaneIdType&) const
    {
    ...
    EIGEN_STRONG_INLINE void
    madd(const LhsPacketType& a, const RhsPacketx4& b, AccPacketType& c, RhsPacket& tmp, const LaneIdType& lane) const
    {
...
class gebp_traits<std::complex<RealScalar>, RealScalar, _ConjLhs, false, Arch, _PacketSize>
{
  public:
    ...
    EIGEN_STRONG_INLINE void madd_impl(
        const LhsPacketType& a, const RhsPacketType& b, AccPacketType& c, RhsPacketType& tmp, const true_type&) const
    {
#ifdef EIGEN_HAS_SINGLE_INSTRUCTION_MADD
        EIGEN_UNUSED_VARIABLE(tmp);
        c.v = pmadd(a.v, b, c.v);
...
class gebp_traits<std::complex<RealScalar>, std::complex<RealScalar>, _ConjLhs, _ConjRhs, Arch, _PacketSize>
{
  public:
    ...
    template <typename LhsPacketType,
              ...
              typename TmpType,
              typename LaneIdType>
    EIGEN_STRONG_INLINE typename enable_if<!is_same<RhsPacketType, RhsPacketx4>::value>::type
