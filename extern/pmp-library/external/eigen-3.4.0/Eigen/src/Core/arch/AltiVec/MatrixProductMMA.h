...
template <int unroll_factor,
          ...
          const Index accRows,
          const Index accCols>
EIGEN_STRONG_INLINE void gemm_unrolled_MMA_iteration(const DataMapper& res,
...
template <typename Scalar,
          ...
          const Index accRows,
          const Index accCols>
void gemmMMA(const DataMapper& res,
             const Scalar* blockA,
             const Scalar* blockB,
             Index rows,
             Index depth,
...
template <int unroll_factor,
          ...
          bool LhsIsReal,
          bool RhsIsReal>
EIGEN_STRONG_INLINE void gemm_complex_unrolled_MMA_iteration(const DataMapper& res,
                                                             const Scalar* lhs_base,
                                                             const Scalar* rhs_base,
                                                             Index depth,
                                                             Index strideA,
...
template <typename LhsScalar,
          ...
          bool LhsIsReal,
          bool RhsIsReal>
void gemm_complexMMA(const DataMapper& res,
