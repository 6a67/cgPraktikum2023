...
enum ImGuiInputFlags_
{
    ...
    ImGuiInputFlags_LockThisFrame
    = 1 << 6, // Access to key data will require EXPLICIT owner ID (ImGuiKeyOwner_Any/0 will NOT accepted for polling).
              // Cleared at end of frame. This is useful to make input-owner-aware code steal keys from
...
IMGUI_API void
ActivateItem(ImGuiID id); // Remotely activate a button, checkbox, tree node etc. given its unique ID. activation is
