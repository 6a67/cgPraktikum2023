 ...
 * Commandline:
 *    --api='vulkan=1.3'
 * --extensions='VK_EXT_debug_report,VK_KHR_portability_enumeration,VK_KHR_surface,VK_KHR_swapchain' c
 *
 * Online:
...
#define VK_KHR_swapchain 1
    ...
    typedef void(GLAD_API_PTR* PFN_vkCmdSetScissor)(VkCommandBuffer commandBuffer,
                                                    ...
                                                    uint32_t scissorCount,
                                                    const VkRect2D* pScissors);
    typedef void(GLAD_API_PTR* PFN_vkCmdSetScissorWithCount)(VkCommandBuffer commandBuffer,
                                                             uint32_t scissorCount,
                                                             const VkRect2D* pScissors);
    ...
    typedef void(GLAD_API_PTR* PFN_vkCmdSetStencilReference)(VkCommandBuffer commandBuffer,
                                                             VkStencilFaceFlags faceMask,
                                                             uint32_t reference);
    typedef void(GLAD_API_PTR* PFN_vkCmdSetStencilTestEnable)(VkCommandBuffer commandBuffer,
                                                              VkBool32 stencilTestEnable);
    ...
    typedef void(GLAD_API_PTR* PFN_vkCmdSetViewport)(VkCommandBuffer commandBuffer,
                                                     ...
                                                     uint32_t viewportCount,
                                                     const VkViewport* pViewports);
    typedef void(GLAD_API_PTR* PFN_vkCmdSetViewportWithCount)(VkCommandBuffer commandBuffer,
                                                              uint32_t viewportCount,
                                                              const VkViewport* pViewports);
    ...
    typedef void(GLAD_API_PTR* PFN_vkCmdWriteTimestamp)(VkCommandBuffer commandBuffer,
                                                        ...
                                                        VkQueryPool queryPool,
                                                        uint32_t query);
    typedef void(GLAD_API_PTR* PFN_vkCmdWriteTimestamp2)(VkCommandBuffer commandBuffer,
